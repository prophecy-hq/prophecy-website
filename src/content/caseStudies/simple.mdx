...
embeddedImagesLocal:
  - ../../images/simple/00.png
  - ../../images/simple/01.png
  - ../../images/simple/02.png
  - ../../images/simple/03.png
  - ../../images/simple/04.png
---
...
`vimeo: https://vimeo.com/369890412`
...
<GatsbyImage
  alt="Collage of photos from the field and sticky notes"
  image={getImage(props.localImages[1])}
/>

#### Realistic, data-rich prototyping

We tested more than 20 prototypes with over 200 clinicians over the course of the project. Our prototypes ranged from simple click-throughs to React based Framer ones to a React Native app that could very accurately simulate real-world, data-rich scenarios. This extensive and iterative testing enabled us to rapidly learn and refine Simple.
...
<GatsbyImage alt="" image={getImage(props.localImages[2])} />
...
<GatsbyImage alt="" image={getImage(props.localImages[3])} />
...
<GatsbyImage alt="" image={getImage(props.localImages[4])} />
